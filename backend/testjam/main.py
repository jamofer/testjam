...
from testjam.routers import admin, auth, users, groups, projects, project_groups, dashboard, suites, cases, testplans, executions, versions, environments, bugs, coverage, members, mentions, tokens, notifications, notification_preferences, settings as settings_router, ws, health
...
app.include_router(environments.projects_router, prefix=settings.API_V1_PREFIX)
app.include_router(environments.environments_router, prefix=settings.API_V1_PREFIX)
app.include_router(bugs.projects_router, prefix=settings.API_V1_PREFIX)
app.include_router(bugs.bugs_router, prefix=settings.API_V1_PREFIX)
