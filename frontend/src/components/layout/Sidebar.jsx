...
import { Bug, FolderKanban, Users, LogOut, UserCircle, FolderOpen, LayoutDashboard, PlayCircle, ClipboardList, ChevronLeft, Server, Shield, ChevronUp, Tag, Search, Settings as SettingsIcon, Webhook as WebhookIcon, X } from "lucide-react"
...
const PROJECT_NAV = [
  ...
  { to: (id) => `/projects/${id}/integrations`, icon: WebhookIcon,    labelKey: "project.integrations"        },
]
